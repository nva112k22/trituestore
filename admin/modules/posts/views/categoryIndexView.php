        ...
        <div id="content" class="fl-right">
            <div class="section" id="title-page">
                <div class="clearfix">
                    ...
                    <a href="?mod=posts&controller=category&action=add" title="" id="add-new" class="fl-left">Thêm mới</a>
                </div>
            </div>
                ...
                <div class="section-detail">
                    <div class="table-responsive">
                        <table class="table list-table-wp">
                            ...
                            <?php
                            $temp = $start;
                            if (!empty($list_posts_category)) {
                                ?>
                                <tbody>
                                    <?php
                                    foreach ($list_posts_category as $item) {
                                        $temp++;
                                        ?>
                                        <tr>
            ...
            <?php
            echo get_pagging($num_page, $page, "?mod=posts&controller=category");
            ?>
        </div>
    </div>
</div>
