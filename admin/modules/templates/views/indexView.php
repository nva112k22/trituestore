        ...
        <div id="content" class="fl-right">           
            <div class="section" id="title-page">
                <div class="clearfix">
                    ...
                    <a href="?mod=templates&action=add" title="" id="add-new" class="fl-left">Thêm mới</a>
                </div>
            </div>            
                                        ...
                                        <tr>
                                            ...
                                            <td class="clearfix">
                                                <div class="tb-title fl-left">
                                                    <span class="tbody-text"><?php echo $item['name']; ?></span>
                                                </div>
                                            </td>
            ...
            <?php
            echo get_pagging($num_page, $page, "?mod=templates");
            ?>
        </div>
    </div>
</div>
