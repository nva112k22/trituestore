        ...
        <div id="content" class="fl-right">           
            <div class="section" id="title-page">
                <div class="clearfix">
                    ...
                    <a href="?mod=media&action=add" title="" id="add-new" class="fl-left">Thêm mới</a>
                </div>
            </div>            
...
<!--                    <div class="actions">
                                        ...
                                        <tr>
                                            ...
                                            <td class="clearfix">
                                                <div class="tb-title fl-left">
                                                    <span class="tbody-text"><img class="images" href="" src="<?php echo $item['image_url']; ?>" /></span>
                                                </div>
                                            </td>
                                            <td><span class="tbody-text"><?php echo $item['image_title']; ?></span></td>
                                            <td><span class="tbody-text"><?php echo $created_user; ?></span></td>
                                            <td><span class="tbody-text"><?php echo date("d-m-Y H:i:s", strtotime($item['created_at'])); ?></span></td>
                                            <td>
            ...
            <?php
            echo get_pagging($num_page, $page, "?mod=media");
            ?>
        </div>
    </div>
</div>
