...
<html>
    ...
    <df-messenger
        intent="WELCOME"
        chat-title="Chat-bot"
        agent-id="342d68f4-a0cd-4221-9986-02a5ee782df8"
        language-code="vi"
        ></df-messenger>
</head>
<body>
...
<!--                                <li>
                                ...
                                <li>
                                    <a href="?mod=orders" title="">Đơn hàng</a>
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    if (!is_login()) {
                                        ?>
                                        <a href="?mod=users&action=login">Đăng nhập</a></p>
                                        <?php
                                    } else {
                                        ?>
                                        <a href="?mod=users&action=logout">Đăng xuất</a></p>
                                        <?php
                                    }
                                    ?>
                                </li>
                ...
                <div id="head-body" class="clearfix">
                    <div class="wp-inner">
                        <a href="?" title="" id="logo" class="fl-left"><img src="public/images/tritue.png"/></a>
                                ...
                                <div id="cart-wp" class="fl-right">
                                    ...
                                    <div id="dropdown">
                                        ...
                                        <dic class="action-cart clearfix">
                                            ...
                                            if (!is_login()) {
                                                ?>
                                                <a href="?mod=users&action=login" title="Thanh toán" class="checkout fl-right">Thanh toán</a>
